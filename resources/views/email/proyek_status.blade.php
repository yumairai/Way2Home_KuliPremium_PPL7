...
@php
    ...
    $tanggalMulai = $proyek->tanggal_mulai ? \Carbon\Carbon::parse($proyek->tanggal_mulai)->isoFormat('D MMMM Y') : '-';
    ...
    $pesanStatus = [
        ...
        'Verifikasi Dokumen' => 'Dokumen proyek Anda sedang dalam proses verifikasi oleh admin. Mohon tunggu konfirmasi selanjutnya.',
        'Revisi Dokumen'     => 'Terdapat dokumen yang perlu direvisi. Silakan cek catatan admin dan upload ulang dokumen yang diperlukan.',
        'Pembayaran DP'      => 'Dokumen proyek Anda telah disetujui! Silakan lakukan pembayaran DP untuk memulai proses pembangunan.',
        'In Progress'        => 'Proyek Anda kini sedang dalam pengerjaan oleh tim mandor kami. Pantau progressnya di aplikasi Way2Home.',
        'Selesai'            => 'Selamat! Proyek pembangunan rumah Anda telah selesai dikerjakan. Terima kasih telah mempercayakan kepada Way2Home.',
        'Ditolak'            => 'Mohon maaf, pengajuan proyek Anda tidak dapat kami proses. Silakan hubungi tim kami untuk informasi lebih lanjut.',
    ];
...
<div class="body">
    ...
    <div class="cta-wrap">
        <a href="{{ config('app.url') }}/customer/proyek" class="cta-btn">
            Lihat Detail Proyek
        </a>
    </div>
</div>
